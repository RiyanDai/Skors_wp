      ...
      <section class="section hero" id="home" aria-label="hero">
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <h1 class="h1 hero-title">Optimizing Your Business Start Here</h1>

            <p class="hero-text">
                Optimalkan potensi bisnis Anda bersama kami! Dengan strategi digital yang tepat, kami siap membantu mencapai target pasar yang lebih luas.
                Wujudkan kesuksesan bisnis Anda sekarang!
            </p>

            <a href="#" class="btn btn-primary">Joined Us</a>

          </div>

          <figure class="hero-banner">
            <img src="<?= get_theme_file_uri( 'img/Business team meeting.png' ) ?>" width="720" height="673" alt="hero banner" class="w-100">
          </figure>
            ...
            <li>
              <div class="project-card">
                ...
                <figure class="card-banner img-holder" style="--width: 510; --height: 700;">
                  <img src="<?= get_theme_file_uri( 'img/project-1.jpg' ) ?>" width="510" height="700" loading="lazy"
            ...
            <li>
              <div class="project-card">
                ...
                <div class="card-content">
                  ...
                  <p class="card-subtitle">advertising</p>
            ...
            <li>
              <div class="project-card">
                ...
                <div class="card-content">
                  ...
                  <p class="card-subtitle">Pay-Per-Click (PPC)</p>
            ...
            <li>
              <div class="project-card">
                ...
                <div class="card-content">
                  ...
                  <p class="card-subtitle">Web Design & Development</p>
            ...
            <li>
              <div class="project-card">
                ...
                <div class="card-content">
                  ...
                  <h3 class="h3">
                    <a href="#" class="card-title">Redesigning an app</a>
                  </h3>
...
GoPro Digital is a full-service digital marketing agency founded back in 2019 that is dedicated to providing industry-leading marketing solutions to clients in Addis Ababa, Ethiopia and beyond.

We take pride in equipping digital marketers to become experts in their field, providing them with the tools and necessary resources to stay ahead of the curve in an ever-evolving digital landscape.

As an agency that specializes in digital marketing, we fully understand the importance of a comprehensive approach to effectively promote our clients' businesses online.
            ...
            <p class="section-text">
              we offer a wide range of services, including website design and development, search engine optimization (SEO), pay-per-click (PPC) advertising, social media management, content marketing, and more. 

Each of the services we have listed are designed to work in tandem, creating a cohesive and effective digital marketing strategy that will help your business stand out from the competition.
            ...
            <ul class="about-list">
              ...
              <li class="about-item">
                ...
                <p class="section-text">
                  Our Digital academy, on the plus side, has graduated 25+ students over the past 6 months. By 2023, we will start to offer diploma courses that will create specialists and experts in the digital marketing profession.
              ...
              <li class="about-item">
                ...
                <p class="section-text">
                  For the past three years, at GoPro Digital, we have designed and implemented SEO strategies that drive traffic, brand engagement, and, more importantly, business growth for many businesses. 
              ...
              <li class="about-item">
                ...
                <p class="section-text">
                  For the most part, through our commitment to our core values, we strive to deliver world-class digital marketing services to a wide range of clients and industries that produce outstanding results.
                </p>
              </li>
